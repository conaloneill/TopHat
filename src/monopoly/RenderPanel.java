...
public class RenderPanel extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		g.drawImage(gotojail, GameScreen.BOARD_WIDTH - GameScreen.TILESIZE, GameScreen.BOARD_HEIGHT - GameScreen.TILESIZE*11, GameScreen.TILESIZE, GameScreen.TILESIZE, this);
